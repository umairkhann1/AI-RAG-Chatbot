...
from langchain_community.vectorstores import Pinecone as BasePinecone
...
# compressor = LLMChainExtractor.from_llm(chat)  # Requires compatible langchain version
...
def answer_questions(pinecone_index):
    ...
    while True:
        ...
        docs = pinecone_index_retriever.get_relevant_documents(query=question)
        main_content = '"""'
        for doc in docs:
