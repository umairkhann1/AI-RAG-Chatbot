...
from langchain_openai import OpenAIEmbeddings, ChatOpenAI  # type: ignore[import]
...
def train_or_load_model(train, file_path, name_space):
    if train:
        ...
        milvus_text_vector_store = Milvus.from_documents(
            documents=pages,
        ...
        milvus_text_vector_store = Milvus(
            collection_name=MILVUS_COLLECTION_NAME,
